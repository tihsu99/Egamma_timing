...
#    wrapper_condor('QCD300toInf', 'root://se01.grid.nchc.org.tw//cms/store/user/tihsu/ele_reRECO/2024-01-19/QCD_Pt-300ToInf_EMEnriched_TuneCP5_14TeV-pythia8/crab_QCD300toInf/240303_221952/0000',  condor, os.path.join(args.outdir, 'endcap'), farm_dir, barrel=False, check=args.check, particle=args.particle)
    ...
    for region_ in ['barrel', 'endcap']:
      wrapper_condor('SinglePhoton2To200_noPU', 'root://se01.grid.nchc.org.tw//cms/store/user/tihsu/ele_reRECO/2024-07-19/SinglePhoton_Pt-2To200-gun/crab_SinglePhoton2to200_wTICL_noPU/240728_033220/0000/', condor, os.path.join(args.outdir, region_), farm_dir, barrel=(region_ == 'barrel'), check=args.check, particle=args.particle)
